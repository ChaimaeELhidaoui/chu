...
const ObservationViewer = Loadable(lazy(()=> import('pages/PDF/observationViewer')));
const CompteRendueViewer = Loadable(lazy(()=> import('pages/PDF/compteRenduViewer')));
const CompteRenduN = Loadable(lazy(() => import('pages/compteRenduN')));
// render - sample page
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/observationViewer',
            element: <ObservationViewer/>
        },
        {
            path: '/compteRendueViewer',
            element: <CompteRendueViewer/>
        },
        {
            path: '/cr',
            element: <CompteRenduN />
        },
